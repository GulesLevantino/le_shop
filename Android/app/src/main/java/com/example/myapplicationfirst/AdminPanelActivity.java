...
public class AdminPanelActivity extends AppCompatActivity {
    ...
    private void createProduct() {
        ...
        String url = "http://10.0.9.1/le_shop/create_product.php";
        ...
        sendRequest(url, jsonObject, "Продукт успешно создан", "Ошибка при создании продукта");
    }
    ...
    private void updateProduct() {
        ...
        String url = "http://10.0.9.1/le_shop/update_product.php";
