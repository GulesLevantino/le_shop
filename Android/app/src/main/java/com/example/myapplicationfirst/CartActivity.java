...
public class CartActivity extends AppCompatActivity {
    ...
    private void loadCartItems() {
        String url = "http://10.09.1/le_shop/get_cart.php?user_id=" + userId;
        Log.d("CartActivity", "Loading cart items: " + url); // Логируем URL запроса
                        ...
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                if (!item.has("product_id") || !item.has("name") || !item.has("price") || !item.has("image_url")) {
                                    Log.e("CartActivity", "Не все данные присутствуют в JSON.");
                            ...
                            Log.e("CartActivity", "Ошибка в обработке данных: " + e.getMessage());
                            Toast.makeText(CartActivity.this, "Ошибка в обработке данных", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
