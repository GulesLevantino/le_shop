...
public class LoginActivity extends AppCompatActivity {
    ...
    private void loginUser(String username, String password) {
        String url = "http://10.0.9.1/le_shop/login.php";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, jsonObject,
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            if (response.getString("status").equals("success")) {
                                ...
                                Toast.makeText(LoginActivity.this, "Некоректный логин или пароль", Toast.LENGTH_SHORT).show();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(LoginActivity.this, "Ошибка с сетью: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
